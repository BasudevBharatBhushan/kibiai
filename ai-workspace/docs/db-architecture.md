...
| `report_template_pivot_metadata_json` | jsonb | DEFAULT `{"rows":[],"columns":[],"values":[]}` | Dynamic pivot table metadata only; separate from report config/data |
...
> **Migration**: `ai-workspace/sql/041_pivot_metadata.sql`
