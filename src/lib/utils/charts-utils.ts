/**
 * @deprecated This is a legacy copy of chartsUtils.ts. Import from chartsUtils.ts instead.
 * Kept for backward-compatibility only. Both files are kept in sync.
 */
...
export function buildOptions(config: ChartConfig): Highcharts.Options {
  ...
  // Non-pie, non-gauge, non-funnel charts
